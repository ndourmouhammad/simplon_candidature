...
return [
    ...
    */
    ...
    | des attributs en utilisant la convention "attribute.rule" pour nommer les lignes.
    | Cela permet de rendre rapidement un message de langue spécifique pour une règle
    | d'attribut donnée.
    |
    */
    ...
    | espace réservé d'attribut par quelque chose de plus convivial pour le lecteur
    | comme "Adresse e-mail" au lieu de "email". Cela nous aide simplement à rendre
    | notre message plus clair.
    |
    */
